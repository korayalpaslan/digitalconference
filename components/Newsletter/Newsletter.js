        ...
        <div className="flex flex-col md:flex-row md:justify-between lg:px-12 lg:items-center">
          ...
          <div className="p-8 lg:px-0 mx-auto md:mx-0 lg:flex lg:justify-end lg:w-1/2">
            <input
              ...
              class="mt-1 block w-full px-3 py-4 border border-border bg-background rounded-md text-sm shadow-sm min-w-[250px] placeholder-gray-400 font-light text-gray-400 mr-0 lg:mr-5 mb-5 lg:mb-0 lg:w-3/5"/>
            <button className="bg-primary hover:bg-primary_dark transition-all duration-300 rounded-full py-4 px-10 text-white min-w-[125px] w-full lg:w-auto cursor font-light">
              Abone Ol
            </button>
          </div>
        </div>
