...
const Program = () => {
  return <div className="h-auto bg-primary pt-12 pb-24 px-0 lg:px-6">
      <div className="text-white">
        <div className="lg:container md:mx-auto 2xl:pt-0 px-6 md:px-12 lg:px-0 flex flex-col md:flex-row md:justify-between items-start">
          <div
